...
export const howToSlugs = [
  ...
  "import-pubnub-functions-from-catalog",
  ...
  "manage-pubnub-functions",
  "manage-pubnub-functions-kv-store",
  "manage-pubnub-functions-secrets",
  ...
  "schedule-pubnub-functions-events",
  ...
  "get-insights-api-access",
  "query-insights-channels",
  "query-insights-filters",
  "query-insights-messages",
  "query-insights-user-behavior-and-devices",
  "query-insights-users",
